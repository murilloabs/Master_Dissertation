...
Devido às não linearidades a solução implícita direta não é possível, adotando-se uma abordagem preditor-corretor com Newton-Raphson. Na etapa de \textbf{previsão}, as estimativas para o próximo passo assumem um incremento nulo de aceleração:
