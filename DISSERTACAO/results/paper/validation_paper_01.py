...
plot_validation(t_1000, bk_1000.backlash_results['d'], "7a.csv", "Fig 7(a) - Distância entre centros (d) a 1000 RPM", "Tempo t /s", "Distância entre centros d /mm", "Fig_7a_CenterDistance.html", [2.4, 2.6], 1000.0, step_sim=step_sim, step_paper=step_paper, constant_ref=d0_ref_mm)
plot_validation(t_1000, alfa_1000_deg, "7b.csv", "Fig 7(b) - Ângulo de pressão (α) a 1000 RPM", "Tempo t /s", "Ângulo de pressão α /(°)", "Fig_7b_PressureAngle.html", [2.4, 2.6], 1.0, step_sim=step_sim, step_paper=step_paper, constant_ref=alfa0_ref_deg)
plot_validation(t_1000, bk_1000.backlash_results['bt'], "7c.csv", "Fig 7(c) - Folga (bt) a 1000 RPM", "Tempo t /s", "Folga bt /μm", "Fig_7c_Backlash.html", [2.4, 2.6], 1e6, step_sim=step_sim, step_paper=step_paper, constant_ref=b0_ref_um)
plot_validation(t_1000, bk_1000.backlash_results['contact_ratio'], "7d.csv", "Fig 7(d) - Razão de contato (mp) a 1000 RPM", "Tempo t /s", "Razão de contato mp", "Fig_7d_ContactRatio.html", [2.4, 2.6], 1.0, step_sim=step_sim, step_paper=step_paper, constant_ref=cr0_ref)

# --- Respostas no Tempo (Fig 9) ---
plot_validation(t_1000, x1_1000, "9a.csv", "Fig 9(a) - Resposta de vibração x1 a 1000 RPM", "Tempo t /s", "Deslocamento x1 /μm", "Fig_9a_Vibration_x1.html", [2.4, 2.52], 1e6, step_sim=step_sim, step_paper=step_paper)
plot_validation(t_1000, delta_1000, "9c.csv", "Fig 9(c) - Resposta de vibração δ (DTE) a 1000 RPM", "Tempo t /s", "DTE δ /μm", "Fig_9c_Vibration_DTE.html", [2.4, 2.52], 1e6, step_sim=step_sim, step_paper=step_paper)
plot_validation(t_1000, bk_1000.backlash_results['Fm'], "9f.csv", "Fig 9(f) - Resposta no tempo da DMF a 1000 RPM", "Tempo t /s", "DMF /kN", "Fig_9f_DMF.html", [2.4, 2.52], 1e-3, step_sim=step_sim, step_paper=step_paper)

# --- FFTs (Fig 9) ---
plot_fft_validation(t_1000, x1_1000, "9b.csv", "Fig 9(b) - Espectro FFT de x1 a 1000 RPM", "Frequência f /kHz", "Amplitude x1 /μm", "Fig_9b_FFT_x1.html", sim_scale_y=1e6, x_range=[0, 0.8], step_paper=step_paper)
plot_fft_validation(t_1000, delta_1000, "9d.csv", "Fig 9(d) - Espectro FFT de δ a 1000 RPM", "Frequência f /kHz", "Amplitude δ /μm", "Fig_9d_FFT_DTE.html", sim_scale_y=1e6, x_range=[0, 6], step_paper=step_paper)

# --- Mapa de Poincaré NATIVO DA CLASSE (Fig 9) ---
plot_poincare_validation(pasta_saida_1000, "9e.csv", "Fig 9(e) - Mapa de Poincaré de δ a 1000 RPM", "δ /μm", "dδ/dt /(mm/s)", "Fig_9e_Poincare.html")
...
# --- Respostas no Tempo ---
plot_validation(t_3000, x1_3000, "10a.csv", "Fig 10(a) - Resposta de vibração x1 a 3000 RPM", "Tempo t /s", "Deslocamento x1 /μm", "Fig_10a_Vibration_x1.html", [0.8, 0.85], 1e6, step_sim=step_sim, step_paper=step_paper)
plot_validation(t_3000, delta_3000, "10c.csv", "Fig 10(c) - Resposta de vibração δ (DTE) a 3000 RPM", "Tempo t /s", "DTE δ /μm", "Fig_10c_Vibration_DTE.html", [0.8, 0.85], 1e6, step_sim=step_sim, step_paper=step_paper)
plot_validation(t_3000, bk_3000.backlash_results['Fm'], "10f.csv", "Fig 10(f) - Resposta no tempo da DMF a 3000 RPM", "Tempo t /s", "DMF /kN", "Fig_10f_DMF.html", [0.8, 0.85], 1e-3, step_sim=step_sim, step_paper=step_paper)

# --- FFTs ---
plot_fft_validation(t_3000, x1_3000, "10b.csv", "Fig 10(b) - Espectro FFT de x1 a 3000 RPM", "Frequência f /kHz", "Amplitude x1 /μm", "Fig_10b_FFT_x1.html", sim_scale_y=1e6, x_range=[0, 4], step_paper=step_paper)
plot_fft_validation(t_3000, delta_3000, "10d.csv", "Fig 10(d) - Espectro FFT de δ a 3000 RPM", "Frequência f /kHz", "Amplitude δ /μm", "Fig_10d_FFT_DTE.html", sim_scale_y=1e6, x_range=[0, 7], step_paper=step_paper)

# --- Mapa de Poincaré NATIVO DA CLASSE ---
plot_poincare_validation(pasta_saida_3000, "10e.csv", "Fig 10(e) - Mapa de Poincaré de δ a 3000 RPM", "δ /μm", "dδ/dt /(mm/s)", "Fig_10e_Poincare.html")
...
# --- Respostas no Tempo ---
plot_validation(t_4500, x1_4500, "11a.csv", "Fig 11(a) - Resposta de vibração x1 a 4500 RPM", "Tempo t /s", "Deslocamento x1 /μm", "Fig_11a_Vibration_x1.html", [0.55, 0.58], 1e6, step_sim=step_sim, step_paper=step_paper)
plot_validation(t_4500, delta_4500, "11c.csv", "Fig 11(c) - Resposta de vibração δ (DTE) a 4500 RPM", "Tempo t /s", "DTE δ /μm", "Fig_11c_Vibration_DTE.html", [0.55, 0.58], 1e6, step_sim=step_sim, step_paper=step_paper)
plot_validation(t_4500, bk_4500.backlash_results['Fm'], "11f.csv", "Fig 11(f) - Resposta no tempo da DMF a 4500 RPM", "Tempo t /s", "DMF /kN", "Fig_11f_DMF.html", [0.55, 0.58], 1e-3, step_sim=step_sim, step_paper=step_paper)

# --- FFTs ---
plot_fft_validation(t_4500, x1_4500, "11b.csv", "Fig 11(b) - Espectro FFT de x1 a 4500 RPM", "Frequência f /kHz", "Amplitude x1 /μm", "Fig_11b_FFT_x1.html", sim_scale_y=1e6, x_range=[0, 3], step_paper=step_paper)
plot_fft_validation(t_4500, delta_4500, "11d.csv", "Fig 11(d) - Espectro FFT de δ a 4500 RPM", "Frequência f /kHz", "Amplitude δ /μm", "Fig_11d_FFT_DTE.html", sim_scale_y=1e6, x_range=[0, 7], step_paper=step_paper)

# --- Mapa de Poincaré NATIVO DA CLASSE ---
plot_poincare_validation(pasta_saida_4500, "11e.csv", "Fig 11(e) - Mapa de Poincaré de δ a 4500 RPM", "δ /μm", "dδ/dt /(mm/s)", "Fig_11e_Poincare.html")
...
plot_validation(t_6000, delta_6000, "12a.csv", "Fig 12(a) - Resposta de vibração δ (DTE) a 6000 RPM", "Tempo t /s", "DTE δ /μm", "Fig_12a_Vibration_DTE.html", [0.4, 0.425], 1e6, step_sim=step_sim, step_paper=step_paper)

# Fig 12(d) - Time Response of DMF
plot_validation(t_6000, bk_6000.backlash_results['Fm'], "12d.csv", "Fig 12(d) - Resposta no tempo da DMF a 6000 RPM", "Tempo t /s", "DMF /kN", "Fig_12d_DMF.html", [0.4, 0.425], 1e-3, step_sim=step_sim, step_paper=step_paper)

# --- FFTs ---
# Fig 12(b) - FFT Spectrum of δ
plot_fft_validation(t_6000, delta_6000, "12b.csv", "Fig 12(b) - Espectro FFT de δ a 6000 RPM", "Frequência f /kHz", "Amplitude δ /μm", "Fig_12b_FFT_DTE.html", sim_scale_y=1e6, x_range=[0, 8], step_paper=step_paper)

# --- Mapa de Poincaré NATIVO DA CLASSE ---
# Fig 12(c) - Poincaré Map of δ
plot_poincare_validation(pasta_saida_6000, "12c.csv", "Fig 12(c) - Mapa de Poincaré de δ a 6000 RPM", "δ /μm", "dδ/dt /(mm/s)", "Fig_12c_Poincare.html")
...
# # 1. Caminho da pasta
# pasta_saida_1000 = r"F:\Mestrado\git\resultados_engrenamento_1000rpm\simulacao_2026-05-13_18h-20m-38s"
...
# path_gif = os.path.join(pasta_saida_1000, "engrenamento_obra_prima.gif")

# bk_1000.animate_gears(
#     scale=250,           # Órbitas super visíveis
#     frames=400,          # Alta qualidade
#     interval=35,         # Gira fluido e rápido
#     revolutions=1,       # Loop perfeito de 1 volta sem travamentos
#     save_path=path_gif
# )
