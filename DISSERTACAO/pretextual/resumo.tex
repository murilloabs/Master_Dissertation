...

{
	\cleardoublepage
	\let\clearpage\relax
	\noindent	SOUSA, M. A. B., \textbf{Implementação de um modelo dinâmico de folga backlash em engrenagens para máquinas rotativas}. 2026. 91 f. Dissertação de Mestrado, Universidade Federal de Uberlândia, Uberlândia.
