...

{
	\cleardoublepage
	\let\clearpage\relax
	\noindent	SOUSA, M. A. B., \textbf{Implementação de modelo de folga de backlash dinâmico em engrenagens para análise de dinâmica de rotação}. 2026. 89 f. Dissertação de Mestrado, Universidade Federal de Uberlândia, Uberlândia.
