...

{
	\cleardoublepage
	\let\clearpage\relax
	\noindent SOUSA, M. A. B., \textbf{Implementation of a dynamic backlash model in gears for rotating machinery.} 2026. 91 p. Master Dissertation, Federal University of Uberlândia, Uberlândia.
