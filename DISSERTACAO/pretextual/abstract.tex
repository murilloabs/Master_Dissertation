...

{
	\cleardoublepage
	\let\clearpage\relax
	\noindent SOUSA, M. A. B., \textbf{Implementation of a dynamic backlash model in gears for rotational dynamics analysis.} 2026. 89 p. Master Dissertation, Federal University of Uberlândia, Uberlândia.
