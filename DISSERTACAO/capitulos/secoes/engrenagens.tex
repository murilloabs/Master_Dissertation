...
A transmissão de potência através de engrenagens é um dos métodos fundamentais em sistemas rotativos, garantindo acoplamento cinemático entre eixos. A geometria do dente modelada pelo perfil de involuta, garante que a relação de transmissão de potência seja feita da melhor maneira possível \cite{shigley2020, norton2020}.

\subsection{Projeto e Geometria de Engrenagens}

O projeto de sistemas engrenados contempla o dimensionamento geométrico apropriado para garantir a relação de transmissão desejada (aumento ou redução de torque e velocidade angular)  assim como a integridade física e dinâmica deste sistema.  Com isso em mente, as engrenagens apresentam geometrias características para o pleno funcionamento do par engrenado. 

Um par engrenado apresenta variáveis comuns às duas engrenagens que são o ângulo de pressão $\alpha$, módulo $m$, ângulo de hélice $\beta$ e espessura do dente $w$. 
