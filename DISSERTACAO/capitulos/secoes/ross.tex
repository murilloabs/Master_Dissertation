...
\begin{itemize}
	...
	\item \texttt{BearingElement} e \texttt{SealElement}: Implementa o suporte dos mancais e os selos nos nós pertinentes. Esta classe permite associar coeficientes de rigidez ($k_{xx}, k_{yy, \cdots}$) e amortecimento ($c_{xx}, c_{yy}, \cdots$) estáticos ou variantes com a velocidade de rotação $\Omega$. Além disso, podem ser considerado os coeficientes cruzados, que relacionam as direções $xy$, $xz$ e $yz$. Portanto, este elemento contribui somente com as matrizes de rigidez $[K]$ e amortecimento $[C]$.
