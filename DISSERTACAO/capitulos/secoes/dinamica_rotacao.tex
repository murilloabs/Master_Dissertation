...
A Figura~\ref{subfigure:modelo} apresenta uma representação de um rotor real com mancais $B1$ e $B2$, disco $D1$ e velocidade $\Omega$ sua modelagem matemática com coeficientes de amortecimento ${C_b}_1$, ${C_b}_2$ e de rigidez ${K_b}_1$ e ${K_b}_2$.
\begin{figure}[H]
	\centering
	\caption{Subfiguras}
