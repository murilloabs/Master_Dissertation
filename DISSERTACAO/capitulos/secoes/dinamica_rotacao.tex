...
A correta modelagem matemática é essencial para o desenvolver análises e resultados robustos, coerentes e confiáveis. Assim, um modelo de elementos finitos para rotores foi desenvolvido por~\citeonline{cavalini2013} com base na modelagem apresentada por~\citeonline{Lalanne1998} é tido como referência para diversos trabalhos. Tal modelo contempla quatro graus de liberdade (\textit{gdl}) por nó, a expansão para seis \textit{gdl} pro nó foi apresentada por~\citeonline{Friswell2010} e adaptado por~\citeonline{sicchieri2024} para o eixo coordenado referente, assim como mostrado na Equação~\ref{Eq:dof}.
