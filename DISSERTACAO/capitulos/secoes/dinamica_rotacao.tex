...
\begin{itemize}
	\item O eixo é representado como um elemento de viga com seção circular constante, de acordo com a Teoria de Timoshenko (\cite{timoshenko1922}). É caracterizado por energia cinética e potencial, onde cada elemento possui dois nós e seis graus de liberdade por nó;
