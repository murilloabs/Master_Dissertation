...
{\color{green}Neste capítulo será apresentada uma revisão e fundamentação teórica a cerca dos temas abordados nesta dissertação. Será apresentado sobre o ROSS, modelagem de rotores pelo métodos dos elementos finitos, engrenagens, e formulação da rigidez de engrenamento.}
